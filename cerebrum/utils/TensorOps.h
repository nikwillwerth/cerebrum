...
class TensorOps {
public:
    static Eigen::Tensor<double, 2, 0, long> dot(Eigen::Tensor<double, 2, 0, long> a, Eigen::Tensor<double, 2, 0, long> b);
    ...
    static Eigen::Tensor<double, 1, 0, long> reshape(Eigen::Tensor<double, 2, 0, long> x, size_t dimOne);
